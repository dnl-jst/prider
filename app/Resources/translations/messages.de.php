...
return [
    // general
    'Prider Server Management' => 'Prider Server Management',
    'Servers' => 'Server',
    'Groups' => 'Gruppen',
    'Users' => 'Benutzer',
    'Key pairs' => 'Schlüssel',
    ...
    // login
    'Please log in with your mail address and your password.' =>
    ...
    'updates available,' => 'Updates verfügbar, davon',
    'Servers without group' => 'Server ohne Gruppe',
    'Are you sure you want to upgrade the server?' => 'Sind Sie sicher, dass Sie den Server upgraden möchten?',
    ...
    'Daily notification' => 'Tägliche Benachrichtigungen',
    ...
    'Are you really sure you want to delete this group?' => 'Sind Sie sicher, dass Sie die Gruppe löschen möchten?',
    ...
    'Are you really sure you want to delete this key pair?' =>
        'Sind Sie sicher, dass Sie den Schlüssel löschen möchten?',
    'Key pair name: %name%' => 'Schlüssel-Name: %name%',
